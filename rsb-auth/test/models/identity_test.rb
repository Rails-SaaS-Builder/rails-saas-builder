...
class RSB::Auth::IdentityTest < ActiveSupport::TestCase
  setup do
  ...
  test "after_identity_created lifecycle handler fires on create" do
    ...
    RSB::Auth.send(:remove_const, :TestIdentityCreatedHandler) if RSB::Auth.const_defined?(:TestIdentityCreatedHandler)
  end
