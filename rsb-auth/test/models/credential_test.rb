...
class RSB::Auth::CredentialTest < ActiveSupport::TestCase
  setup do
  ...
  test "after_credential_locked lifecycle handler fires when locked" do
    ...
    RSB::Auth.send(:remove_const, :TestCredentialLockedHandler) if RSB::Auth.const_defined?(:TestCredentialLockedHandler)
  end
end
