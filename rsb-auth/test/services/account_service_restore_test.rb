...
module RSB
  module Auth
    class AccountServiceRestoreTest < ActiveSupport::TestCase
      setup do
      ...
      test 'restore_account fires after_identity_restored lifecycle hook' do
        ...
        if RSB::Auth.const_defined?(:TestRestoredIdentityHandler)
          RSB::Auth.send(:remove_const, :TestRestoredIdentityHandler)
        end
      end
