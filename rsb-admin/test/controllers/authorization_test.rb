...
class AuthorizationTest < ActionDispatch::IntegrationTest
  test "superadmin can access all resources" do
    ...
    admin = RSB::Admin::AdminUser.create!(email: "super-#{SecureRandom.hex(4)}@example.com", password: "password123", password_confirmation: "password123", role: role)
  ...
  test "restricted role is denied access to unauthorized resources" do
    ...
    admin = RSB::Admin::AdminUser.create!(email: "restricted-#{SecureRandom.hex(4)}@example.com", password: "password123", password_confirmation: "password123", role: role)
  ...
  test "role with specific permissions can access allowed resources" do
    ...
    admin = RSB::Admin::AdminUser.create!(email: "rolemanager-#{SecureRandom.hex(4)}@example.com", password: "password123", password_confirmation: "password123", role: role)
  ...
  test "admin without role is denied access (no role = no access)" do
    admin = RSB::Admin::AdminUser.create!(email: "norole-auth-#{SecureRandom.hex(4)}@example.com", password: "password123", password_confirmation: "password123")
  ...
  test "forbidden response renders the forbidden page with proper content" do
    admin = RSB::Admin::AdminUser.create!(email: "norole-forbidden-#{SecureRandom.hex(4)}@example.com", password: "password123", password_confirmation: "password123")
  ...
  test "forbidden page hides dashboard link when user has no dashboard permission" do
    admin = RSB::Admin::AdminUser.create!(email: "norole-nodash-#{SecureRandom.hex(4)}@example.com", password: "password123", password_confirmation: "password123")
