...
class AdminUserTest < ActiveSupport::TestCase
  ...
  test "requires unique email (case insensitive)" do
    RSB::Admin::AdminUser.create!(email: "admin@example.com", password: "password123", password_confirmation: "password123", role: @role)
    admin = RSB::Admin::AdminUser.new(email: "ADMIN@example.com", password: "password123", password_confirmation: "password123", role: @role)
    refute admin.valid?
    assert_includes admin.errors[:email], "has already been taken"
  end

  test "requires valid email format" do
    admin = RSB::Admin::AdminUser.new(email: "not-an-email", password: "password123", password_confirmation: "password123")
    refute admin.valid?
  ...
  test "does not require password on update if not provided" do
    admin = RSB::Admin::AdminUser.create!(email: "admin@example.com", password: "password123", password_confirmation: "password123", role: @role)
  ...
  test "can? delegates to role" do
    ...
    admin = RSB::Admin::AdminUser.create!(email: "editor@example.com", password: "password123", password_confirmation: "password123", role: editor_role)
  ...
  test "can? returns false when role is nil (no role = no access)" do
    admin = RSB::Admin::AdminUser.create!(email: "noRole@example.com", password: "password123", password_confirmation: "password123")
  ...
  test "belongs_to role is optional" do
    admin = RSB::Admin::AdminUser.new(email: "admin@example.com", password: "password123", password_confirmation: "password123")
    assert admin.valid?
  end
end
