module RSB
  module Auth
    ...
    class LifecycleHandler
      ...
      # @return [void]
      def after_credential_revoked(credential)
      end
      ...
      # @return [void]
      def after_credential_restored(credential)
      end
      ...
      # @return [void]
      def after_identity_deleted(identity)
      end
      ...
      # @return [void]
      def after_identity_restored(identity)
      end
    end
  end
end
