...
class RSB::Auth::VerificationServiceTest < ActiveSupport::TestCase
  setup do
  ...
  test "verify does not fire after_identity_verified on failure" do
    ...
    RSB::Auth.configuration.lifecycle_handler = nil
    RSB::Auth.send(:remove_const, :TestVerifiedNotFiredHandler) if RSB::Auth.const_defined?(:TestVerifiedNotFiredHandler)
  end
end
