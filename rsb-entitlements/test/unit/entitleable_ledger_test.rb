...
class EntitleableLedgerTest < ActiveSupport::TestCase
  ...
  test 'usage_history returns ordered records most recent first' do
    ...
    RSB::Entitlements::UsageCounter.create!(countable: @org, metric: 'api_calls', period_key: '2026-02-11',
                                            plan: @plan, current_value: 100, limit: 1000)
    RSB::Entitlements::UsageCounter.create!(countable: @org, metric: 'api_calls', period_key: '2026-02-12',
                                            plan: @plan, current_value: 200, limit: 1000)
    RSB::Entitlements::UsageCounter.create!(countable: @org, metric: 'api_calls', period_key: '2026-02-13',
                                            plan: @plan, current_value: 300, limit: 1000)
