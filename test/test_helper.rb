...
class ActiveSupport::TestCase
  ...
  def register_all_admin_categories
    RSB::Admin.registry.register_category "Authentication" do
      resource RSB::Auth::Identity,
        icon: "users",
        actions: [:index, :show, :new, :create, :suspend, :activate, :deactivate,
        ...
        column :primary_identifier, label: "Email / Username", visible_on: [:index, :show]
      ...
      resource RSB::Auth::Invitation,
        icon: "mail",
        actions: [:index, :new, :create, :revoke] do
    ...
    RSB::Admin.registry.register_category "Billing" do
      ...
      resource RSB::Entitlements::Entitlement,
        icon: "shield",
        actions: [:index, :show, :grant, :revoke, :activate] do
      ...
      resource RSB::Entitlements::PaymentRequest,
        icon: "receipt",
        actions: [:index, :show, :approve, :reject, :refund],
        ...
        column :currency
        column :created_at, formatter: :datetime, visible_on: [:index, :show]
  ...
  alias_method :register_all_admin_categories_v2, :register_all_admin_categories
  alias_method :register_all_admin, :register_all_admin_categories
end
