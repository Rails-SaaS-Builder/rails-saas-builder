    ...
    module Admin
      class UsageCountersControllerTest < ActionDispatch::IntegrationTest
        ...
        test "index renders usage counters table" do
          create_test_usage_counter(countable: @org, metric: "api_calls", plan: @plan, period_key: "2026-02-13", current_value: 42, limit: 1000)
        ...
        test "index filters by metric" do
          create_test_usage_counter(countable: @org, metric: "api_calls", plan: @plan, period_key: "2026-02-13", current_value: 42, limit: 1000)
          create_test_usage_counter(countable: @org, metric: "projects", plan: @plan, period_key: "__cumulative__", current_value: 5, limit: 10)
        ...
        test "trend renders chart for specified metric" do
          create_test_usage_counter(countable: @org, metric: "api_calls", plan: @plan, period_key: "2026-02-11", current_value: 100, limit: 1000)
          create_test_usage_counter(countable: @org, metric: "api_calls", plan: @plan, period_key: "2026-02-12", current_value: 200, limit: 1000)
          create_test_usage_counter(countable: @org, metric: "api_calls", plan: @plan, period_key: "2026-02-13", current_value: 300, limit: 1000)
